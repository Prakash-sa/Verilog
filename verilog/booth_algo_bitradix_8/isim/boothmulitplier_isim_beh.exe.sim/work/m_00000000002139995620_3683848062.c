...
LAB7:    xsi_set_current_line(8, ng0);
    t8 = ((char*)((ng1)));
    xsi_vlogtype_sign_extend(t7, 16, t8, 1);
    t9 = (t0 + 1608);
...
LAB9:    xsi_set_current_line(9, ng0);
    t3 = (t0 + 1048U);
    t4 = *((char **)t3);
    xsi_vlogtype_sign_extend(t7, 16, t4, 8);
    t3 = (t0 + 1608);
...
LAB24:    xsi_set_current_line(13, ng0);
    ...
    t2 = (t0 + 1048U);
    t3 = *((char **)t2);
    xsi_vlogtype_sign_extend(t7, 16, t3, 8);
    t2 = ((char*)((ng5)));
    memset(t10, 0, 8);
    xsi_vlog_signed_arith_lshift(t10, 16, t7, 16, t2, 32);
    t4 = (t0 + 1608);
...
LAB26:    t17 = *((unsigned int *)t10);
    ...
    *((unsigned int *)t8) = (t18 & 65535U);
    t19 = ((char*)((ng2)));
    memset(t20, 0, 8);
    xsi_vlog_unsigned_add(t20, 16, t10, 16, t19, 16);
    t21 = (t0 + 1608);
    ...
    t8 = ((char*)((ng5)));
    memset(t10, 0, 8);
    xsi_vlog_signed_arith_lshift(t10, 16, t4, 16, t8, 32);
    t9 = (t0 + 1608);
