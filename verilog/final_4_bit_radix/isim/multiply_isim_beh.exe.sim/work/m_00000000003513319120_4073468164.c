...
LAB7:    xsi_set_current_line(9, ng0);
    t8 = ((char*)((ng1)));
    xsi_vlogtype_sign_extend(t7, 8, t8, 1);
    t9 = (t0 + 1608);
...
LAB9:    xsi_set_current_line(10, ng0);
    t3 = (t0 + 1048U);
    t4 = *((char **)t3);
    xsi_vlogtype_sign_extend(t7, 8, t4, 4);
    t3 = (t0 + 1608);
...
LAB24:    xsi_set_current_line(14, ng0);
    ...
    t2 = (t0 + 1048U);
    t3 = *((char **)t2);
    xsi_vlogtype_sign_extend(t7, 8, t3, 4);
    t2 = ((char*)((ng5)));
    memset(t10, 0, 8);
    xsi_vlog_signed_arith_lshift(t10, 8, t7, 8, t2, 32);
    t4 = (t0 + 1608);
...
LAB26:    t17 = *((unsigned int *)t10);
    ...
    *((unsigned int *)t8) = (t18 & 255U);
    ...
    t8 = ((char*)((ng5)));
    memset(t10, 0, 8);
    xsi_vlog_signed_arith_lshift(t10, 8, t4, 8, t8, 32);
    t9 = (t0 + 1608);
...
extern void work_m_00000000003513319120_4073468164_init()
{
	static char *pe[] = {(void *)Always_6_0};
	xsi_register_didat("work_m_00000000003513319120_4073468164", "isim/multiply_isim_beh.exe.sim/work/m_00000000003513319120_4073468164.didat");
